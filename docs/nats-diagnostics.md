...
The Raspberry Pi remains the NATS authority for the integration environment. HiL/SiL must not silently create a second authority or change the production subject contract.
