...
This will become the colcon workspace for the HiL/SiL packages. Source packages belong under `src/`.

Planned packages include:

- `rov_description` — hull, thrusters, joints, and sensor frames.
